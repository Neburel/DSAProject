...
namespace DSAProjektKomponententest.Classes.Charakter.Values.Attribute
{
    ...
    public class BaseInitiativeTest : AbstractAttributeValuesTest
    {
        public override int ExpectedValue()
        {
            ...
            var var2 = Attribute.GetAttributMAXValue(DSALib.CharakterAttribut.Mut, out error);
            ErrorHelper.ExpectErrorNull(error);
            var var3 = Attribute.GetAttributMAXValue(DSALib.CharakterAttribut.Intuition, out error);
            ErrorHelper.ExpectErrorNull(error);
            var var4 = Attribute.GetAttributMAXValue(DSALib.CharakterAttribut.Gewandheit, out error);
            ErrorHelper.ExpectErrorNull(error);
